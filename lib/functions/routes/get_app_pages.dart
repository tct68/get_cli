...
void addAppPage(String name, String bindingDir, String viewDir) {
  ...
  if (supportChildrenRoutes) {
    ...
    while (pathSplit.isNotEmpty && onPageIndex == -1) {
      onPageIndex =
          lines.indexWhere((element) => element.contains('_Paths.${pathSplit.last.snakeCase.camelCase},'), indexRoutes);
...
${_getTabs(tabEspaces + 1)}name: $routesOrPath.${nameSnakeCase.camelCase}, 
